...
INC=-I$(BASEPATH)/include -I$(BASEPATH) -I$(IOPATH)/inc -I$(BASEPATH)/libcm -I$(BASEPATH)/lua/src -I$(BASEPATH)/lua/LuaBridge -I$(BASEPATH)/lua/LuaBridge/detail
...
DEF = -DLINUX -D__THREAD_SPIN_LOCK__ -DUSE_LOGCLIENT -mfpmath=387
DEF += -D__USER__=\"$(USER)\"
