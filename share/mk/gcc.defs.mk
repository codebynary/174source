...
INCLUDES = -I. -I$(TOP_SRCDIR) -I$(LUA_DIR)/src -I$(LUA_DIR)/LuaBridge -I$(LUA_DIR)/LuaBridge/detail -I$(IO_DIR) -I$(CO_DIR) -I$(TOP_SRCDIR)/rpc -I$(TOP_SRCDIR)/inl -I$(TOP_SRCDIR)/rpcdata -I/usr/include/libxml2 -I../iolib/inc -I/usr/include/openssl
